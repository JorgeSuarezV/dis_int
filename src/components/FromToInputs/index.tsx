    ...
    return (
        <div className={"flex flex-col justify-start items-start w-full p-4 gap-4"}>
            <div className={"flex flex-row justify-start h-[43]px w-full gap-4 items-center"}>
                ...
                <input {...firstInput} className={"flex-grow flex w-full h-11 p-3 px-4 rounded-3xl outline-none border border-gray-300"}/>
            </div>
            <div className={"flex flex-row justify-start h-[43]px w-full gap-4 items-center"}>
                <input {...secondInput} className={"flex-grow flex w-full h-11 p-3 px-4 rounded-3xl outline-none border border-gray-300"}/>
